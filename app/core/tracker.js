playtemEmbeddedApp.TagProviderChain.Core.createSmartadTracker = function(eventType, providerName) {
    var buildUrl = function() {
        var timestamp = playtemEmbeddedApp.TagProviderChain.Core.date.getCurrentTimestamp();
