...
playtemEmbeddedApp.Core.createSmartadTracker = function(eventType, providerName) {
    var buildUrl = function() {
        var timestamp = playtemEmbeddedApp.Core.date.getCurrentTimestamp();
...
playtemEmbeddedApp.Core.Identifiers = {
    newGUID : function() {
        var S4 = function() {
